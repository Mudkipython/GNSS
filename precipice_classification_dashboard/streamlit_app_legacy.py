...
# An explicit override is intended for an authorized local/private deployment.
# Public deployments must not point this at the legacy full-resolution bundle.
...
def hero() -> None:
    st.markdown(
        ...
        <div class="geo-hero">
            ...
            <span class="geo-badge">Interactive evidence review</span>
            <h1>PRECIPICE GNSS-IR review studio</h1>
            <p>
                Explore the observing product, physical context, proxy-label diagnostics, and
                time-aware model evidence from the Week 5 and Week 7 analyses.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
